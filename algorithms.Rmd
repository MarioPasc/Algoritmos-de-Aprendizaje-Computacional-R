...
double_cross_validation_naiveBayes <- function(data, target_name, outer, inner, variables, threshold) {
  set.seed(90)
...
# Todas las variables
performance_naiveBayes_todasVariables <- double_cross_validation_naiveBayes(data = data_factor, 
                                                             outer = 5,
                                                             inner = 2,
                                                             target_name = "PCR",
                                                             ...
                                                             threshold = 0.35)
# Asociación
performance_naiveBayes_asociacion <- double_cross_validation_naiveBayes(data = data_factor, 
                                                             outer = 5,
                                                             inner = 2,
                                                             target_name = "PCR",
...
```{r, message=FALSE, warning=FALSE}
double_cross_validation_naiveBayes_stepAUC <- function(data, target_name, outer, inner, variables, threshold) {
  set.seed(90)
  performance_metrics <- data.frame(Fold = integer(), TP = integer(), TN = integer(),
...
```{r, message=FALSE, warning=FALSE}
double_cross_validation_naiveBayes_lasso <- function(data, target_name, outer, inner, variables, threshold) {
  set.seed(90)
  performance_metrics <- data.frame(Fold = integer(), TP = integer(), TN = integer(),
                                    FP = integer(), FN = integer(), AUC = numeric(),
                                    Best_Variables = character(), stringsAsFactors = FALSE)
...
```{r, message=FALSE, warning=FALSE}
double_cross_validation_adaboost <- function(data, target_name, outer, inner, iterations, variables, threshold) {
  set.seed(90)
  performance_metrics <- data.frame(Fold = integer(), TP = integer(), TN = integer(),
                                    FP = integer(), FN = integer(), AUC = numeric(), 
...
# Todas las variables
performance_adaboost_todasvariables <- double_cross_validation_adaboost(data = data_factor, 
                                                         outer = 5,
                                                         inner = 2,
                                                         target_name = "PCR",
                                                         ...
                                                         threshold = 0.35)
# Asociacion
performance_adaboost_asociacion <- double_cross_validation_adaboost(data = data_factor, 
                                                         outer = 5,
                                                         inner = 2,
                                                         target_name = "PCR",
                                                         iterations = c(50, 100, 150),
...
```{r, message=FALSE, warning=FALSE}
double_cross_validation_adaboost_stepAUC <- function(data, target_name, outer, inner, iterations, variables, threshold) {
  set.seed(90)
  performance_metrics <- data.frame(Fold = integer(), TP = integer(), TN = integer(),
                                    FP = integer(), FN = integer(), AUC = numeric(),
...
```{r}
double_cross_validation_adaboost_lasso <- function(data, target_name, outer, inner, iterations, variables, threshold) {
  set.seed(90)
  performance_metrics <- data.frame(Fold = integer(), TP = integer(), TN = integer(),
                                    FP = integer(), FN = integer(), AUC = numeric(),
...
performance_adaboost_lasso <- double_cross_validation_adaboost_lasso(data = data_factor, 
                                                               outer = 5,
                                                               inner = 2,
                                                               target_name = "PCR",
                                                               iterations = c(50, 100, 150),
...
```{r, message=FALSE, warning=FALSE}
double_cross_validation_rpart <- function(data, target_name, outer, inner, cp_values, minsplit_values, variables, threshold) {
  set.seed(90)
  performance_metrics <- data.frame(Fold = integer(), TP = integer(), TN = integer(),
                                    FP = integer(), FN = integer(), AUC = numeric(),
...
# Todas las variables
performance_rpart_todasvariables <- double_cross_validation_rpart(data = data,
                                                   outer = 5,
                                                   inner = 2,
                                                   target_name = "PCR",
...
```{r, message=FALSE, warning=FALSE}
double_cross_validation_rpart_stepAUC <- function(data, target_name, outer, inner, cps, minsplits, variables, threshold) {
  set.seed(90)
  performance_metrics <- data.frame(Fold = integer(), TP = integer(), TN = integer(),
                                    FP = integer(), FN = integer(), AUC = numeric(),
...
performance_rf_stepAUC <- double_cross_validation_rpart_stepAUC(data = data_factor, 
                                                        outer = 5,
                                                        inner = 2,
                                                        target_name = "PCR",
                                                        cps = c(0.01, 0.05, 0.1),
...
```{r, message=FALSE, warning=FALSE}
double_cross_validation_rpart_Lasso <- function(data, target_name, outer, inner, cps, minsplits, variables, threshold) {
  set.seed(90)
  performance_metrics <- data.frame(Fold = integer(), TP = integer(), TN = integer(),
                                    FP = integer(), FN = integer(), AUC = numeric(),
...
performance_rf_lasso <- double_cross_validation_rpart_Lasso(data = data_factor, 
                                                      outer = 5,
                                                      inner = 2,
                                                      target_name = "PCR",
                                                      cps = c(0.01, 0.05, 0.1),
...
# Todas las variables
performance_knn_todasvariables <- double_cross_validation_knn(data = data_numeric, 
                                               outer = 5,
                                               inner = 2,
                                               target_name = "PCR",
                                               ...
                                               threshold = 0.35)
# Asociacion
performance_knn_asociacion <- double_cross_validation_knn(data = data_numeric, 
                                               outer = 5,
                                               inner = 2,
                                               target_name = "PCR",
                                               ks = c(10, 16, 20, 25, 30, 32),
...
```{r, message=FALSE, warning=FALSE}
double_cross_validation_knn_stepAUC <- function(data, target_name, outer, inner, ks, ls, variables, threshold) {
  set.seed(90)
  performance_metrics <- data.frame(Fold = integer(), TP = integer(), TN = integer(),
                                    FP = integer(), FN = integer(), AUC = numeric(),
...
performance_knn_stepAUC <- double_cross_validation_knn_stepAUC(data = data_numeric, 
                                                       outer = 5,
                                                       inner = 2,
                                                       target_name = "PCR",
                                                       ks = c(10, 16, 20, 25, 30, 32),
...
```{r, message=FALSE, warning=FALSE}
double_cross_validation_knn_lasso <- function(data, target_name, outer, inner, ks, ls, variables, threshold) {
  set.seed(90)
  performance_metrics <- data.frame(Fold = integer(), TP = integer(), TN = integer(),
                                    FP = integer(), FN = integer(), AUC = numeric(),
...
performance_knn_lasso <- double_cross_validation_knn_lasso(data = data_factor,
                                                     outer = 5,
                                                     inner = 2,
                                                     target_name = "PCR",
                                                     ks = c(10, 16, 20, 25, 30, 32),
...
double_cross_validation_svm <- function(data, target_name, outer, inner, kernels, costs, variables, threshold) {
  set.seed(90)
  performance_metrics <- data.frame(Fold = integer(), TP = integer(), TN = integer(),
                                    FP = integer(), FN = integer(), AUC = numeric(),
...
# Todas las variables
performance_svm_todasVariables <- double_cross_validation_svm(data = data_factor, 
                                               outer = 5,
                                               inner = 2,
                                               target_name = "PCR",
                                               kernels = c("linear"),
                                               ...
                                               threshold = 0.35)
# Asociacion
performance_svm_asociacion <- double_cross_validation_svm(data = data_factor, 
                                               outer = 5,
                                               inner = 2,
                                               target_name = "PCR",
                                               kernels = c("linear"),
...
```{r, message=FALSE, warning=FALSE}
double_cross_validation_svm_stepAUC <- function(data, target_name, outer, inner, kernels, costs, variables, threshold) {
  set.seed(90)
  performance_metrics <- data.frame(Fold = integer(), TP = integer(), TN = integer(),
                                    FP = integer(), FN = integer(), AUC = numeric(),
...
```{r}
double_cross_validation_svm_lasso <- function(data, target_name, outer, inner, kernels, costs, variables, threshold) {
  set.seed(90)
  performance_metrics <- data.frame(Fold = integer(), TP = integer(), TN = integer(),
                                    FP = integer(), FN = integer(), AUC = numeric(),
...
```{r, message=FALSE, warning=FALSE}
double_cross_validation_nnet <- function(data, target_name, outer, inner, sizes, decays, variables, threshold) {
  set.seed(90)
  performance_metrics <- data.frame(Fold = integer(), TP = integer(), TN = integer(),
                                    FP = integer(), FN = integer(), AUC = numeric(),
...
# Todas las variables
performance_nn_todasVariables <- double_cross_validation_nnet(data = data_factor, 
                                               outer = 5,
                                               inner = 2,
                                               target_name = "PCR",
                                               sizes = c(5,10,15,20),
                                               ...
                                               threshold=.35)
# Asociación
performance_nn_asociacion <- double_cross_validation_nnet(data = data_factor, 
                                               outer = 5,
                                               inner = 2,
                                               target_name = "PCR",
                                               sizes = c(5,10,15,20),
...
```{r, message=FALSE, warning=FALSE}
double_cross_validation_nnet_stepAUC <- function(data, target_name, outer, inner, sizes, decays, variables, threshold) {
  set.seed(90)
  performance_metrics <- data.frame(Fold = integer(), TP = integer(), TN = integer(),
                                    FP = integer(), FN = integer(), AUC = numeric(),
...
# Uso de la función con los parámetros correspondientes
performance_nn_stepAUC <- double_cross_validation_nnet_stepAUC(data = data_factor, 
                                                       outer = 5,
                                                       inner = 2,
                                                       target_name = "PCR",
                                                       sizes = c(5, 10, 15, 20),
...
```{r, message=FALSE, warning=FALSE}
double_cross_validation_nnet_lasso <- function(data, target_name, outer, inner, sizes, decays, threshold) {
  set.seed(90)
  performance_metrics <- data.frame(Fold = integer(), TP = integer(), TN = integer(),
                                    FP = integer(), FN = integer(), AUC = numeric(),
                                    Best_Size = integer(), Best_Decay = numeric(), Best_Variables = character(), stringsAsFactors = FALSE)
...
# Uso de la función con los parámetros correspondientes
performance_nn_lasso <- double_cross_validation_nnet_lasso(data = data_factor, 
                                                     outer = 5,
                                                     inner = 2,
                                                     target_name = "PCR",
                                                     sizes = c(5, 10, 15, 20),
