...
```{r, message=FALSE, warning=FALSE}
load("RData_Files_Algorithms/RandomForest_Aparente")
```
...
```{r, message=FALSE, warning=FALSE}
load("RData_Files_Algorithms/RandomForest_TodasVariables")
```
...
```{r, message=FALSE, warning=FALSE}
load("RData_Files_Algorithms/RandomForest_Asociacion")
```
### Wrapped (StepAUC)
...
```{r, message=FALSE, warning=FALSE}
load("RData_Files_Algorithms/RandomForest_StepAUC")
```
...
```{r, message=FALSE, warning=FALSE}
load("RData_Files_Algorithms/RandomForest_Lasso")
```
...
```{r, message=FALSE, warning=FALSE}
load("RData_Files_Algorithms/KNN_Aparente")
```
...
```{r, message=FALSE, warning=FALSE}
load("RData_Files_Algorithms/KNN_TodasVariables")
```
...
```{r, message=FALSE, warning=FALSE}
load("RData_Files_Algorithms/KNN_Asociacion")
```
...
```{r, message=FALSE, warning=FALSE}
load("RData_Files_Algorithms/KNN_StepAUC")
```
...
```{r, message=FALSE, warning=FALSE}
load("RData_Files_Algorithms/KNN_Lasso")
```
...
```{r, message=FALSE, warning=FALSE}
load("RData_Files_Algorithms/SVM_Aparente")
```
...
```{r, message=FALSE, warning=FALSE}
load("RData_Files_Algorithms/SVM_TodasVariables")
```
...
```{r, message=FALSE, warning=FALSE}
load("RData_Files_Algorithms/SVM_Asociacion")
```
...
```{r, message=FALSE, warning=FALSE}
load("RData_Files_Algorithms/SVM_StepAUC")
```
...
```{r, message=FALSE, warning=FALSE}
load("RData_Files_Algorithms/SVM_Lasso")
```
...
```{r, message=FALSE, warning=FALSE}
load("RData_Files_Algorithms/ANN_Aparente")
```
...
```{r, message=FALSE, warning=FALSE}
load("RData_Files_Algorithms/ANN_TodasVariables")
```
...
```{r, message=FALSE, warning=FALSE}
load("RData_Files_Algorithms/ANN_Asociacion")
```
...
```{r, message=FALSE, warning=FALSE}
load("RData_Files_Algorithms/ANN_StepAUC")
```
...
```{r, message=FALSE, warning=FALSE}
load("RData_Files_Algorithms/ANN_Lasso")
```
